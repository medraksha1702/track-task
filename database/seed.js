...
async function seed() {
    try {
        ...
        // Create admin user
        const [admin, created] = await index_1.User.findOrCreate({
        ...
        const customer1 = await index_1.Customer.create({
            name: 'Dr. John Smith',
        ...
        const customer2 = await index_1.Customer.create({
        ...
        const customer3 = await index_1.Customer.create({
        ...
        const machine1 = await index_1.Machine.create({
        ...
        const machine2 = await index_1.Machine.create({
        ...
        const machine3 = await index_1.Machine.create({
        ...
        const service1 = await index_1.Service.create({
        ...
        const service2 = await index_1.Service.create({
        ...
        const service3 = await index_1.Service.create({
            customerId: customer1.id,
        ...
        const service4 = await index_1.Service.create({
        ...
        const invoice1 = await index_1.Invoice.create({
            customerId: customer1.id,
        ...
        await index_1.InvoiceItem.create({
        ...
        const invoice2 = await index_1.Invoice.create({
            customerId: customer2.id,
        ...
        const invoice3 = await index_1.Invoice.create({
            customerId: customer1.id,
        ...
        await index_1.InvoiceItem.bulkCreate([
            {
